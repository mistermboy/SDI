...
public class ServletCarrito extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		getServletContext().getRequestDispatcher("/vista-carrito.jsp").forward(
				request, response);
	}

	private void insertarEnCarrito(Map<String, Integer> carrito,
	...
	private String carritoEnHTML(Map<String, Integer> carrito) {
		...
		for (String key : carrito.keySet())
			carritoEnHTML += "<p>[" + key + "], " + carrito.get(key)
					+ " unidades</p>";

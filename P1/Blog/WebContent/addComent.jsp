...
<body>
	...
	<jsp:useBean id="comentario" class="com.sdi.Comentario" />
	<jsp:setProperty name="comentario" property="*" />
	
	<c:if test="${comentario.autor != null}">
		<jsp:useBean id="comentariosService"
			class="com.sdi.ComentariosService" />
	...
	<div class="container" id="contenedor-principal">
		...
		<form class="form-horizontal" method="post" action="addComent.jsp">
